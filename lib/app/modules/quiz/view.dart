              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, questionIndex) => Column(
                  ...
                  children: [
                    ...
                    Text(
                      _controller.dataList[questionIndex]["question"]
                          .toString(),
                      style: TextStyle(
                    ...
                    GetBuilder(
                      ...
                      initState: (_) {},
                      builder: (_) {
                        final options = _controller.dataList[questionIndex]
                            ["options"] as List;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _controller.getCurrentPage() ==
                            ...
                            : Text(
                                "${(_controller.pageController.page ?? 0).toInt() + 1}/${_controller.dataList.length}",
                                style: TextStyle(
                                  fontSize: 24.h,
                                  fontFamily: "Rakkas",
                                ),
